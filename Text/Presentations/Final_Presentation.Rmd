...
```{r boxNH4N, fig.cap = "Box Plot of Region and Ammoniacal Nitrogen", out.width = "80%", out.height = "60%", message = FALSE, echo = FALSE, warnings = FALSE}
...
```{r boxTN, fig.cap = "Box Plot of Region and Total Nitrogen", out.width = "80%", out.height = "60%", echo = FALSE, message = FALSE}
...
```{r boxSECCHI, fig.cap = "Box Plot of Region and Clarity", out.width = "80%", out.height = "60%", echo = FALSE, message = FALSE}
...
Our leading question was; is there a difference in the lake health variables between the different types of dominant landcover?  

We wanted to investigate this along with whether clarity can be explained by the other four lake health variables. 
