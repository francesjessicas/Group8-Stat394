...
First we analysed the distribution of the lake health variables by dominant landcover. Some sample statistics are below in table \ref{tab:WHAAAAAAAT}. 
...
We also found one lake with no entry for region so we excluded this observation when analysing region with the lake health or dimension variables.  
