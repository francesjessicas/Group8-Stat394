...
We analysed the relationship between the Lake Health variables and Region. Table \ref{tab:sec} shows the mean and median of the Ammoniacal Nitrogen, Chlorophyll-A and Total Phosphorus for each region, and table \ref{tab:tab2} shows Total Nitrogen and Clarity. All of these variables are sorted in descending order, except Clarit, which is sorted in ascending order. 
...
```{r sec, message = FALSE, warnings = FALSE, echo = FALSE}
...
```{r tab2, message = FALSE, warnings = FALSE, echo = FALSE}
knitr::kable(tab2, caption = "Regional Mean and Median Lake Health", format="latex") %>% kable_styling(latex_options="scale_down")
```

We then looked at the summary statistics of region by the Lake Health variables, shown in table \ref{tab:lakehealthbyregion}.
