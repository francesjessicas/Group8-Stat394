...
We produced a partition plot to examine the separation which can be seen here \ref{fig:partition1}  
...
```
  ...
  In the second LDA both groups had prior probabilities of 0.5 (this is because the train happened to split them with an equal number of observations of 1242 each. The partition can be seen here \ref{fig:partition2}  
