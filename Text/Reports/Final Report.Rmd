...
We analysed the relationship between the Lake Health variables and Region. Table \ref{tab:sec} shows the mean and median of the Ammoniacal Nitrogen, Chlorophyll-A and Total Phosphorus for each region, and table \ref{tab:tab2} shows Total Nitrogen and Clarity. 
