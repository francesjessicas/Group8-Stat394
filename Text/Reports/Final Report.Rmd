...
We analysed the relationship between the Lake Health variables and Region. EXPLAIN
...
tab1 <- cbind(taba, tabc, tabp, tabn, tabs)
...
As demonsta=rated in our Exploratory data Analysis, the distributios of the Lake Health variables for each landcover type was not normal. We performed Kruskal-Wallis tests for multivariate difference in means between landcover for each Lake Health variable and all of these tests concluded that there was a difference. We then conducted pairwise Wilcox tests to discover which landcovers had different means to others. 
